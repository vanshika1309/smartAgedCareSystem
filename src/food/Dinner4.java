 ...
 *
 */
public class Dinner4 extends MealsPopMenu {

	// variable to store user selection for this class
	public static String dinnerSelection4;
	 ...
	 */
	public Dinner4(double maxX, double maxY) {
		// shows stage
		super.showStage();
		...
		toggleGroup.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
			public void changed(ObservableValue<? extends Toggle> observable, Toggle oldToggle, Toggle newToggle) {
				if (toggleGroup.getSelectedToggle() != null) { // or observable != null
					...
					dinnerSelection4 = (toggleGroup.getSelectedToggle().getUserData().toString());
					// prints the users selection
					System.out.println(dinnerSelection4);
				}
			}
		});
	}
